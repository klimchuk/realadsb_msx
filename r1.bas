...
5070 METAR$="2022/04/09 00:51"+CHR$(13)+CHR$(10)+"KEWR 090051Z 17006KT 10SM FEW060 14/M01 A2968 RMK AO2"
5080 X=1:L=0:C=LEN(METAR$)
5090 N=INSTR(X,METAR$,CHR$(13)):IF N=0 AND X<C THEN N=C
5100 PSET(30,40+L*10),0
5110 PRINT #1,MID$(METAR$,X,N-X)
5120 X=N+2:L=L+1
5130 IF X<C THEN 5090
5200 B$=INKEY$
