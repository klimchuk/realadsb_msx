...
5110 METAR$="2022/04/09 00:51"+CHR$(10)+"KEWR 090051Z 17006KT 10SM FEW060 14/M01 A2968 RMK AO2 PK WND 30028/1340 SLP088 T00891044"
5120 X=1:L=0:C=LEN(METAR$)
5130 N=INSTR(X,METAR$,CHR$(10)):IF N=0 AND X<C THEN N=C
